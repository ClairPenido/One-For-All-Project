...
ENGINE = InnoDB;
    ...
    INSERT INTO SpotifyClone.Musica ( nome_musica, duracao_musica, id_artista )
  VALUES
...
ENGINE = InnoDB;
 ...
 INSERT INTO SpotifyClone.Reprodução (id_usuario, id_musica, data_reprodução)
   VALUES
...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`Seguindo` (
  `id_seguindo` INT NOT NULL AUTO_INCREMENT,
  `id_usuario` INT NOT NULL,
  `id_artista` INT NOT NULL,
